...
const AddBook = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    // Convert FormData to object and include coverImage
    const data = {
    ...
    try {
      ...
      await PostingBooks(data);

      // Success handling
      setSuccessBookTitle(data.title || "Untitled Book");
      setShowSuccess(true);
  ...
  return (
    <div className="relative max-w-4xl mx-auto py-8 px-4">
      ...
      {/* ========================================================
          FLOATING SUCCESS CONFIRMATION BANNER (Zero layout shift)
          ======================================================== */}
        ...
        <AnimatePresence>
          {showSuccess && (
            <motion.div
              ...
              className="pointer-events-auto w-full p-4 rounded-2xl bg-white/95 dark:bg-[#192230]/95 backdrop-blur-md border border-emerald-500/25 dark:border-emerald-500/20 text-emerald-800 dark:text-emerald-300 shadow-xl flex items-start justify-between gap-3"
            >
              <div className="flex items-start gap-3 min-w-0">
                <div className="flex items-center justify-center w-6 h-6 rounded-full bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 shrink-0 text-sm font-bold">
                  ✓
                </div>
                <div className="min-w-0">
                  <h4 className="text-sm font-black tracking-tight text-emerald-800 dark:text-emerald-400">Submission Received</h4>
                  <p className="text-xs text-slate-600 dark:text-slate-400/90 mt-0.5 leading-relaxed">
                    <strong className="text-slate-800 dark:text-white">"{successBookTitle}"</strong> has been submitted successfully. Please wait for administrator approval before it appears in the Browse Book section.
                  </p>
                </div>
              </div>
              <button
      ...
      <AnimatePresence mode="wait">
        {/* ========================================================
            1. PREMIUM PENDING LIBRARIAN SCREEN
            ======================================================== */}
        {librarianStatus === "pending" ? (
          <motion.div
            ...
            className="relative max-w-xl mx-auto mt-8 p-8 rounded-3xl border border-slate-200/50 dark:border-gray-800/50 bg-white/60 dark:bg-[#192230]/40 backdrop-blur-xl shadow-2xl overflow-hidden"
          >
            ...
            <div className="relative flex flex-col items-center text-center">
              {/* Rotating Dashed Border Icon Accent */}
            ...
            >
              ...
              <div className="space-y-5">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <Select isRequired name="genre" placeholder="Select a genre" className="flex flex-col gap-1">
                    <Label className="text-xs font-bold text-slate-700 dark:text-slate-300">Genre</Label>
                    <Select.Trigger className="h-10 px-3 w-full rounded-xl border border-slate-200 dark:border-gray-800/80 bg-white dark:bg-[#12141c]/20 text-sm text-slate-800 dark:text-slate-200 flex items-center justify-between focus-within:border-amber-500 focus-within:ring-1 focus-within:ring-amber-500 transition-colors cursor-pointer">
              ...
              <div className="flex flex-col gap-5 justify-between">
                <div>
                  ...
                  {/* LOADING BAR (Displays progress status from upload simulation) */}
                  <AnimatePresence>
                    {isUploading && (
                      <motion.div
