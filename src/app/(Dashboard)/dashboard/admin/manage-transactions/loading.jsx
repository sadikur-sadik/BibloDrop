    ...
    <div className="p-5 rounded-2xl border border-slate-200/80 dark:border-gray-800/80 bg-white/40 dark:bg-[#2c2f38]/10 backdrop-blur-md space-y-4 animate-pulse">
      ...
      <div className="flex items-start justify-between gap-4">
        <div className="space-y-1.5 flex-1 min-w-0">
          <div className="h-2.5 bg-slate-200/60 dark:bg-slate-800/40 rounded w-24" />
          <div className="h-4 bg-[#856a26]/10 dark:bg-[#ffcd00]/10 rounded w-3/4" />
        </div>
        <div className="text-right shrink-0 space-y-1.5">
          <div className="h-2.5 bg-slate-200/60 dark:bg-slate-800/40 rounded w-12 ml-auto" />
          <div className="h-4 bg-emerald-500/20 rounded w-16" />
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-y-3 gap-x-4 pt-3 border-t border-slate-200/60 dark:border-gray-800/60 text-xs">
        ...
        <div className="col-span-2 flex justify-between items-center pt-2 border-t border-slate-100 dark:border-gray-800/40">
          ...
          <div className="h-3.5 w-28 bg-slate-150 dark:bg-slate-800/40 rounded" />
        </div>
      </div>
    </div>
  );
  ...
  return (
    <tr className="border-b border-slate-200/60 dark:border-gray-800/60 last:border-0 animate-pulse">
      ...
      <td className="py-4 pl-4">
        <div className="h-4 bg-[#856a26]/10 dark:bg-[#ffcd00]/10 rounded w-36 font-mono" />
      </td>
      ...
      {/* Librarian Email / ID */}
      <td className="py-4">
        <div className="h-3.5 bg-slate-150 dark:bg-slate-800/40 rounded w-40" />
      </td>
      ...
      <td className="py-4 pr-4 text-right">
        <div className="h-3.5 bg-slate-150 dark:bg-slate-800/40 rounded w-24 ml-auto" />
      </td>
    </tr>
  );
};

// Main Transaction History Loading Page
  ...
  return (
    <div className="relative w-full bg-transparent text-[#192230] dark:text-white transition-colors duration-300 space-y-6">
      ...
      >
        ...
        {/* Transactions list loading area */}
...
export default ManageTransactionsLoading;
