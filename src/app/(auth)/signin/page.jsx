...
const SignIn = () => {
    ...
    try {
      await authClient.signIn.email({
        ...
        onSuccess: (ctx) => {
          ...
          // Role-based routing: Adjust paths to match your project architecture
  ...
  // Social Sign-in Trigger (e.g., Google OAuth)
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button
                ...
                className="h-8 border border-gray-200 dark:border-[#2c2f38] bg-transparent text-[#192230] dark:text-white rounded-md text-[11px] font-semibold hover:bg-gray-50 dark:hover:bg-[#2c2f38]/50 transition-colors duration-200 flex items-center justify-center gap-1.5"
              >
