...
const DeleteReview = ({ review, onDelete }) => {
            ...
            {({ close }) => (
              <>
                ...
                <Modal.Body className="py-5 text-sm text-slate-600 dark:text-[#9ea7b3] leading-relaxed">
                  Are you absolutely sure you want to delete the review written by <strong className="text-slate-900 dark:text-white font-extrabold">"{review?.reviewerName}"</strong>? This action will permanently delete this feedback entry from the registry.
                </Modal.Body>
