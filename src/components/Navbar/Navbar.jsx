...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full max-w-360 border-b border-gray-100 bg-white text-[#192230] transition-colors duration-300 dark:border-[#2c2f38] dark:bg-[#192230] dark:text-[#FFFFFF]">
      <div className="sticky top-0 z-50 mx-auto w-full max-w-360 bg-linear-to-b from-white/90 to-gray-100/90 dark:from-[#192230]/90 dark:to-[#121821]/90 backdrop-blur-md border-b border-gray-100/70 dark:border-[#2c2f38]/60 transition-colors duration-300">
